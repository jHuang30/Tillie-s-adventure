...
export default class Animals {
  ...
  update() {
    ...
    if (
      collision(this, this.game.player, -15) &&
      collisionUpDown(this, this.game.player, -15)
    ) {
      this.follow = true;
      if (!this.added) {
        this.game.chicken += 1;
    ...
    if (this.follow) {
      if (
        !collision(this, this.game.player, 105) &&
        collisionUpDown(this, this.game.player, 105)
      ) {
        this.follow = false;
        if (this.added) {
          this.game.chicken -= 1;
        ...
        collision(this, this.game.player, 25) &&
        collisionUpDown(this, this.game.player, 25)
      ) {
      ...
      this.game.player.path.forEach(pos => {
        if (this.position.x > pos[0] + 10) {
          this.speedX = -this.maxSpeed;
